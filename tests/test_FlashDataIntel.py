...
def test_be_constructed_with(chip_info_entry: ChipInfoEntry, hex_file: IntelHex) -> None:
    FlashDataIntel(chip_info_entry, hex_file)


def test_rom_data(flash_data_intel: FlashDataIntel) -> None:
    ...
    assert flash_data_intel.rom_data == expected


def test_eeprom_data(flash_data_intel: FlashDataIntel) -> None:
    ...
    assert flash_data_intel.eeprom_data == expected


def test_id_data(flash_data_intel: FlashDataIntel) -> None:
    expected = bytes.fromhex('0000070f')
    assert flash_data_intel.id_data == expected


def test_fuse_data(flash_data_intel: FlashDataIntel) -> None:
    expected = [16204]
    assert flash_data_intel.fuse_data == expected